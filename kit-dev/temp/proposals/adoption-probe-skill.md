...
> - [layout-profile.mjs](../../../frontend-workflow-kit/scripts/lib/layout-profile.mjs) — `mergeRoles`(Axis 1 재바인딩), `materializeGuardedSurface`
> - [expo-feature.yaml](../../../frontend-workflow-kit/presets/expo-feature.yaml) — 내장 7 role
> - [lib/catalog-gen.mjs:23](../../../frontend-workflow-kit/scripts/lib/catalog-gen.mjs) — `UI_MARKER` 하드코딩(F4/P1) · CLI wrapper [catalog-gen.mjs](../../../frontend-workflow-kit/scripts/catalog-gen.mjs)(기본 --src)
> - [figma-component-mapping.template.md](../../../frontend-workflow-kit/templates/screen/figma-component-mapping.template.md) — 시각 받아적기 계약
...
> - 선례: [adapt-lint-pack/SKILL.md](../../../frontend-workflow-kit/skills/adapt-lint-pack/SKILL.md)(scan→map→diff→rollout→propose) ·
>   `adoption-onboarding-walkthrough.md`(Phase A `adapt` 가정 — **미커밋 로컬 sibling, 이 PR 미포함**)
...
| # | 템플릿 | 역할 | 작업 매핑 |
|---|---|---|---|
| 1 | [adoption-report.template.md](../../../frontend-workflow-kit/templates/adoption/adoption-report.template.md) | 최상위 probe 리포트(환경·role map·can/can't·평탄화·명령관찰·blind spots) | 작업 3·4·5·6 |
| 2 | [project-layout.template.yaml](../../../frontend-workflow-kit/templates/adoption/project-layout.template.yaml) | Axis 1 role→glob 초안 + Tier3 `layers:` 주석 미리보기(inert) | 작업 3·6 |
| 3 | [tier3-gap-report.template.md](../../../frontend-workflow-kit/templates/adoption/tier3-gap-report.template.md) | Axis 2 사각지대 상세(계층↔Tier3 매핑·F1~F5 발현·평탄화 손실·닫는 PR) | 작업 4·6 |
| 4 | [visual-spec-intake-note.template.md](../../../frontend-workflow-kit/templates/adoption/visual-spec-intake-note.template.md) | Figma facts/token/baseline **받아적기** 계약(수집기 구현 안 함) | 작업 7 |
| 5 | [testid-intake-note.template.md](../../../frontend-workflow-kit/templates/adoption/testid-intake-note.template.md) | testID = recommended, not gate | 작업 8 |
...
|---|---|---|:---:|---|---|
| **B1** | catalog-gen `ui_primitive` 하드코딩 | 비표준 ui 경로 → catalog 0건 → `component_catalog_generated:false` → rough-fixture-ui 진입 차단 | 🔇 silent(0건) | dry-run **F4** · [lib/catalog-gen.mjs:23](../../../frontend-workflow-kit/scripts/lib/catalog-gen.mjs) · 보고서 §2 #3 | **PR-0a**(ui_primitive 소비) |
...
| **B6** | forbidden-paths 미강제 | 경로 backstop 이 warning-first 인데 **CI step 자체가 없음** | 🟡 warning-only(비차단) | 보고서 §1.2 · [forbidden-paths.mjs](../../../frontend-workflow-kit/scripts/forbidden-paths.mjs) | (도입 후 OD-11 계열) |
...
```
(npm alias: `workflow:state` · `workflow:readiness` · `workflow:validate` · `workflow:catalog` — [package.json](../../../frontend-workflow-kit/package.json))
...
## Cross-links
- 선행 워크스루: `adoption-onboarding-walkthrough.md`(Phase A `adapt` = probe 의 *다음* 단계 — **미커밋 로컬 sibling, 이 PR 미포함**)
- 선례 스킬: [adapt-lint-pack/SKILL.md](../../../frontend-workflow-kit/skills/adapt-lint-pack/SKILL.md) · [implement-screen/SKILL.md](../../../frontend-workflow-kit/skills/implement-screen/SKILL.md)
