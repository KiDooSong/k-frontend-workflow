...
| IN-20260613-api-001 | api | resolves-decision | reconciled | pending-user-decision | artifact:open-decision-register | decision:D-003@open-decision-register | - |
| IN-20260803-meeting-101 | meeting | conflict | reconciled | delegated | artifact:conflicts | conflict:C-901@conflicts | - |
...
| IN-20260803-meeting-101 | 01 | input-input-conflict | conflict | create-open | conflict:C-901@conflicts | input:IN-20260803-meeting-101#extracted-facts/01 | inherit | statement | inherit |
