...
- **조용한 green 금지.** drift는 `reconcile-input`/Open Decision 파이프라인으로 흐른다 — 스펙 갱신 vs 구현 회귀를 **사람이 판정**한다([input-reconciliation.md](../../../../../frontend-workflow-kit/docs/reference/input-reconciliation.md)).
...
- 기존 축: [investigation-and-verification.md](../../../../investigation-and-verification.md) · [input-reconciliation.md](../../../../../frontend-workflow-kit/docs/reference/input-reconciliation.md) · [roadmap-current.md](../../../../roadmap-current.md)
