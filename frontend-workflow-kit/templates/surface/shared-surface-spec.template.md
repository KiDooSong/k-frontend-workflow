...
<!-- 기본은 legacy active 불릿. per-candidate deferred 가 필요하면 legacy 불릿을 모두 지우고
     docs/reference/api-candidate-deferral.md 의 v2 표를 사용한다. Slice Paths는 . 또는 .. 세그먼트가
     없는 canonical exact path 또는 terminal /**만 허용하며 모든 candidate-like 표는 정확히 하나여야 한다. -->
