...
- Future generated test target, if approved later: `{test_dir}/{domain}/{screen-slug}/{scenario-slug}.spec.ts`
...
**File:** `{test_dir}/{domain}/{screen-slug}/{scenario-slug}.spec.ts`
