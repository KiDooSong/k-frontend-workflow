---
title: API Error Policy (expected-llm-after)
status: draft
---

# API Error Policy — expected-llm-after

> IN-20260613-qa-001 반영: network/offline 분기와 Retry 동작 추가. **순수 simple-update** 라 expected-after 와 내용이 같다(결정 불필요).
