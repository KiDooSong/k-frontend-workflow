...
> - [lib/catalog-gen.mjs:23](../../scripts/lib/catalog-gen.mjs) — `UI_MARKER` 하드코딩(F4/P1) · CLI wrapper [catalog-gen.mjs](../../scripts/catalog-gen.mjs)(기본 --src)
...
> - 선례: [adapt-lint-pack/SKILL.md](../../skills/adapt-lint-pack/SKILL.md)(scan→map→diff→rollout→propose) ·
...
|---|---|---|:---:|---|---|
| **B1** | catalog-gen `ui_primitive` 하드코딩 | 비표준 ui 경로 → catalog 0건 → `component_catalog_generated:false` → rough-fixture-ui 진입 차단 | 🔇 silent(0건) | dry-run **F4** · [lib/catalog-gen.mjs:23](../../scripts/lib/catalog-gen.mjs) · 보고서 §2 #3 | **PR-0a**(ui_primitive 소비) |
