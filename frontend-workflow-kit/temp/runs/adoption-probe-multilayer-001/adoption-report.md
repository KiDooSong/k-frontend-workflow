...
| `node scripts/catalog-gen.mjs --src <probe-run>/scratch/project/src --layout <probe-run>/project-layout.draft.yaml --out <probe-run>/component-catalog.observed.md` | 0 | 1 components observed from src/components/ui/** | catalog F4 observation |
