...
npm test
# PASS — test-fixtures 27 fixtures(26 pass, 1 xfail) + node:test 100 pass
```
...
- 리뷰 반영 회귀는 `C10`~`C14` 로 고정: multiline path injection, Windows/UNC absolute output, out-of-base sourceFiles, malformed conventions.
