...
npm test
# PASS — test-fixtures 27 fixtures(26 pass, 1 xfail) + node:test 108 pass
```
...
- 리뷰 반영 회귀는 `C10`~`C17` 로 고정: multiline path/header injection, Windows/UNC absolute output, out-of-base sourceFiles, malformed conventions, role-root escape, single-glob string[] roles.
