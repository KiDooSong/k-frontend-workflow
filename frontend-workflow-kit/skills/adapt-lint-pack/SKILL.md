...
정책 경계(layout/policy/lint) 변경은 live 교체가 아니라 draft/review 다 — [workflow spine](../../docs/reference/workflow-spine.md)
의 [Stage 10](../../docs/reference/workflow-stages/10-policy-layout-tier3-changes.md) 와 같은 인간 소유 게이트 모델을 따른다.
어떤 사실이 어느 문서에 사는지는 [doc-ownership.md](../../docs/reference/doc-ownership.md). lint 정책 정본은 아래 "정책 정본" 에 나열된
catalog/ratchet 문서다 — 이 스킬은 그 규칙을 복제하지 않고 대조·제안만 한다.
...
- 정책 정본:
  - `tools/frontend-workflow/docs/reference/lint-policy-catalog.md`
  - `tools/frontend-workflow/docs/reference/lint-policy-rollout-ratchet.md`
