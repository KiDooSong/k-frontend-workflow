...
| e2e authoring rules (assertion / locator / coverage) | [`e2e-authoring-rules.md`](e2e-authoring-rules.md) | keep "assert app state not browser artifacts; scope rows by container testid+id" inline; link the catalog + examples |
