...
- [Design-token Naming 규약 (VS-2)](drafts/design-token-naming-convention.md) — 토큰 ID "받아 적기" 규약(네임스페이스·권장 vs 허용 형식·W1 형식/W2 존재 검사 분리). 값·생성·검증은 소비 레포, 킷은 수집기·생성기 미번들.
