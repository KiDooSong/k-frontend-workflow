...
- 기존 evidence 축: [investigation-and-verification.md](../../../../investigation-and-verification.md) (Verification Matrix) · [input-reconciliation.md](../../../../input-reconciliation.md) (drift reconcile)
