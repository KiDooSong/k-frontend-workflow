...
적용된 변경: CI smoke job 2개(#160) · `engines >=20` + lock 동기화 · kit/루트 README 지원 표 · CHANGELOG 기록 · 위 mode 정규화 2건. **런타임 스크립트 내용 변경 0.**
...
- 사후 payload manifest hash: `.kit-payload-manifest.json` sha256 = `6fbeb00a24390c6e4a48d5432ce20a6f6038719f9051a78d564a6db50d3ef9ec`
  (사전 대비 변경 요인: `package.json` engines, README 지원 표, 2파일 mode `100755`→`100644` — 전부 PR B 의도 변경분)
