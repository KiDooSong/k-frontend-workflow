...
> 🗄 **HISTORICAL / SUPERSEDED (2026-07-11 표기)**: 이 보드는 MVP-B 병렬 작업(2026-06-14 종결,
> 전 lane 머지 + rc1 릴리스)의 조정 기록이다. **현재 계획이 아니다** — 현행 계획·구현 상태는
> [kit-dev/roadmap-current.md](../../kit-dev/roadmap-current.md), 릴리스 이력은
> [kit-dev/CHANGELOG.md](../../kit-dev/CHANGELOG.md)(현행 baseline `0.3.0-mvp.1`)가 정본이다.
> 분류·보존 규칙: [evidence-retention-policy.md](../../kit-dev/evidence-retention-policy.md).
