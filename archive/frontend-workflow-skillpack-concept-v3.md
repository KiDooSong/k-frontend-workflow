...
> 버전: v3 (2026-06-12) — v1은 `archive/frontend-workflow-skillpack-concept.md`,
> v2는 `archive/frontend-workflow-skillpack-concept-v2.md` 참고.
>
> v3 변경점 (v2 대비):
...
frontend-workflow-kit/
  ...
  templates/
    ...
    screen/        screen-spec.template.md      # 통합형 1파일
...
- 생성물(workflow-state.yaml, component-catalog.md, eslint.workflow.config.mjs):
...
scripts:   lint-gen.mjs, lint-baseline.mjs, workflow-state.mjs, readiness.mjs, validate.mjs
